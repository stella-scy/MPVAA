...
def multihead_attention(queries,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        print('V_', V_)
        print('tf.transpose(K_, [0, 2, 1])', tf.transpose(K_, [0, 2, 1]))
        # Multiplication
